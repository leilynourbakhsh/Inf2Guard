...
class DataSet(object):
    ...
    def make_loaders(self, workers, batch_size, args, data_aug=True, subset=None,
...
class EMNIST(DataSet):
    def __init__(self, data_path='/tmp/', **kwargs):
        ...
        super(EMNIST, self).__init__('mnist', data_path, **ds_kwargs)
...
class INCOME(DataSet):
    def __init__(self, data_path='/tmp/', **kwargs):
        self.ds_kwargs = {
            ...
            'custom_class': None,
            'label_mapping': None,
            'transform_train': da.TRANSFORMS_DEFAULT,
            'transform_test': da.TRANSFORMS_DEFAULT
        }
        self.num_classes = 2
        self.transform_train = da.TRANSFORMS_DEFAULT
        self.transform_test = da.TRANSFORMS_DEFAULT
        self.data = pd.read_csv('./income/train.csv')
        self.data_path = 'F:/GitHub/Phoni/income/'
        self.ds_name = 'income'
