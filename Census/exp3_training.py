...
def plot_tsne_3d(features, labels):
    ...
    ax.scatter(reduced_features[selected_labels == 0, 0], reduced_features[selected_labels == 0, 1], reduced_features[selected_labels == 0, 2], label='Class 0', alpha=0.5, s=10)
    ax.scatter(reduced_features[selected_labels == 1, 0], reduced_features[selected_labels == 1, 1], reduced_features[selected_labels == 1, 2], label='Class 1', alpha=0.5, s=10)
    #ax.legend()
